<template>
  <div class="component-root interviews-component">
    ...
    <div v-else-if="displayInterviews.length === 0 && showPlaceholder" class="interviews-empty">
      ...
      <p>Add your featured interviews</p>
    </div>
...
// Show placeholder when in builder mode with no interviews
