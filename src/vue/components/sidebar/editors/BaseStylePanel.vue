...
const componentSettings = computed(() => {
  ...
  if (!settings || Array.isArray(settings) || typeof settings !== 'object') {
    console.warn('BaseStylePanel: Invalid or missing settings, using defaults');
...
// ROOT FIX: ALL update methods must use store.updateComponent() to trigger Vue watcher
// Direct mutations break reactivity - the watcher in main.js never fires
