...
describe('CallToActionRenderer', () => {
  ...
  const defaultProps = {
    componentId: 'call-to-action-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(CallToActionRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(CallToActionRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('call-to-action-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(CallToActionRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(CallToActionRenderer, {
        props: {
          componentId: 'test',
