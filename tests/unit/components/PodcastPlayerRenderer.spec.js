...
describe('PodcastPlayerRenderer', () => {
  let wrapper;

  const defaultProps = {
    componentId: 'podcast-player-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(PodcastPlayerRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(PodcastPlayerRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('podcast-player-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(PodcastPlayerRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(PodcastPlayerRenderer, {
        props: {
          componentId: 'test',
