...
describe('VideoIntroRenderer', () => {
  let wrapper;

  const defaultProps = {
    componentId: 'video-intro-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(VideoIntroRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(VideoIntroRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('video-intro-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(VideoIntroRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(VideoIntroRenderer, {
        props: {
          componentId: 'test',
