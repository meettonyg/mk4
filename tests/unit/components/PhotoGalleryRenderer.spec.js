...
describe('PhotoGalleryRenderer', () => {
  ...
  const defaultProps = {
    componentId: 'photo-gallery-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(PhotoGalleryRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(PhotoGalleryRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('photo-gallery-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(PhotoGalleryRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(PhotoGalleryRenderer, {
        props: {
          componentId: 'test',
