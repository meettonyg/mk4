...
describe('AuthorityHookRenderer', () => {
  let wrapper;

  const defaultProps = {
    componentId: 'authority-hook-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(AuthorityHookRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(AuthorityHookRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('authority-hook-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(AuthorityHookRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(AuthorityHookRenderer, {
        props: {
          componentId: 'test',
