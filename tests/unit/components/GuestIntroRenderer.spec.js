...
describe('GuestIntroRenderer', () => {
  let wrapper;

  const defaultProps = {
    componentId: 'guest-intro-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(GuestIntroRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(GuestIntroRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('guest-intro-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(GuestIntroRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(GuestIntroRenderer, {
        props: {
          componentId: 'test',
