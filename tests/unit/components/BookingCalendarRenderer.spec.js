...
describe('BookingCalendarRenderer', () => {
  let wrapper;

  const defaultProps = {
    componentId: 'booking-calendar-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(BookingCalendarRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(BookingCalendarRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('booking-calendar-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(BookingCalendarRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(BookingCalendarRenderer, {
        props: {
          componentId: 'test',
