...
describe('TestimonialsRenderer', () => {
  ...
  const defaultProps = {
    componentId: 'testimonials-test-1',
    data: {
  ...
  beforeEach(() => {
    wrapper = mount(TestimonialsRenderer, {
      props: defaultProps,
      global: {
        plugins: [
          createTestingPinia({
  ...
  describe('Rendering', () => {
    ...
    it('handles missing data gracefully', () => {
      const wrapperNoData = mount(TestimonialsRenderer, {
        props: {
          componentId: 'test',
          data: {}
        },
  ...
  describe('Props Handling', () => {
    it('handles all required props', () => {
      expect(wrapper.props('componentId')).toBe('testimonials-test-1');
  ...
  describe('Error Handling', () => {
    it('handles null data', () => {
      const wrapperNull = mount(TestimonialsRenderer, {
        props: {
          componentId: 'test',
          data: null
        },
    ...
    it('handles undefined values', () => {
      const wrapperUndefined = mount(TestimonialsRenderer, {
        props: {
          componentId: 'test',
